...
size = [3,5,1,2,6] # in some cases the w can be any value
price = [4,6,7,5,1] 
n = len(size)
#w = len(size) # THE SIZE OF THE ROD IS FIXED AT MAX LEN
w = 10 # rod is of length 10 but the price of selected lengths are given
...
'''
IN THIS CASE THE PIECES ARE GIVEN SELECTIVELY
'''